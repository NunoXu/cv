...
\begin{tightitemize}
    ...
    \begin{innertightitemize}
        \item \textbf{WWO} (Launched 2017 - In continuous development) - an online multiplayer strategy game
        \item \textbf{Soccer Avatars} (Launched 2017) - a card creator app for the card game Soccer Avatars
