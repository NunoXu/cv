...
\begin{tightitemize}
    \vspace{\topsep}
    \item Performed continuous development for the web game \href{https://www.worldwaronline.com/}{\phuline{WWO} (World War Online)} , using \textbf{PHP}.
    \item Developed apps for \textbf{Android} and \textbf{iOS} in \textbf{Unity}:
    \begin{innertightitemize}
        \item \href{https://www.chilltime.com/products/marble}{\phubline{Unnamed puzzle game}} (In Development) - a board puzzle game
