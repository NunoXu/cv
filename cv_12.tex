...
In order to increase \textbf{trustfulness} in \textbf{virtual agents}, this research aims to create a module that will suggest actions to improve trust on the agent. To this end, a cognitive trust model is also being implemented.
